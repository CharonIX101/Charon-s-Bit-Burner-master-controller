...
// All times are in milliseconds. Comments are allowed; loader handles them.
...
export const masterConfig = {
  ...
  rooting: {
    enabled: true,
    sweepIntervalMs: 1200000,      // 20 minutes
  ...
  // -------------------------------------------------------
  logging: {
    summaryIntervalMs: 300000, // 5 minutes
    console: {
      summaryEnabled: true,
      errorsEnabled: true,
      moneyEnabled: true,
